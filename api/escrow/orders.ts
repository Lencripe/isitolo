...
/**
 * Creates a new escrow order from a validated POST request body, stores it, and responds with the created order.
 *
 * Validates that the request method is POST and the body conforms to the expected order schema; responds with 405 for non-POST requests and 400 for validation errors.
 *
 * @returns The created EscrowOrder object when the request succeeds (response body for HTTP 201).
 */
