            ...
            <form className="p-6 space-y-4" onSubmit={saveCollection}>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 min-h-24"
                ...
                <div className="p-4">
                  ...
                  {items.length > 0 ? (
                    <div className="mt-4 space-y-2">
                      {items.map((item) => (
                        <div key={item.id} className="flex items-center justify-between rounded-md border border-gray-200 dark:border-gray-700 px-3 py-2">
                          <div>
          ...
          <Card>
            <div className="p-6">
              ...
              {savedCollections.length === 0 ? (
                <p className="text-gray-500">No collections yet. Create your first one on the left.</p>
              ) : (
                <div className="space-y-4">
                  {savedCollections.map((collection) => (
                    <Card key={collection.id} className="bg-gray-50 dark:bg-gray-900/50">
                      <div className="p-4">
                        ...
                        <p className="text-xs text-gray-500 mb-1">Items: {collection.items.length}</p>
                        <p className="text-xs text-gray-500 mb-1">Royalty: {collection.royaltyBps} bps</p>
                        <p className="text-xs text-gray-500">Created: {new Date(collection.createdAt).toLocaleString()}</p>
                      </div>
                    </Card>
                  ))}
                </div>
